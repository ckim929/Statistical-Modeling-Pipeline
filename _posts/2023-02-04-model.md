...
This credit card dataset is a very imbalanced dataset, so using most default machine learning algorithms would pose a problem as most algorithms prioritize the maximization of accuracy. Accuracy is not the metric I want to use because it is very misleading in an imbalanced classification problem. 
